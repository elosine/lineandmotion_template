...
console.log("PIECEDURSEC: " + PIECEDURSEC);
...
console.log("section1dur: " + section1dur);
//Section 4: Short Hocket :11-:17
...
console.log("section2dur: " + section2dur);
//Section 3: Hocket/Crescendos/Accel 57-63% of what is left
var section3dur = s2thru4 - section2dur;
console.log("section3dur: " + section3dur);
console.log("section4dur: " + section4dur);
// SECTION 1 ------------------------------------------------------------- //
...
console.log("sec1NumTempi: " + sec1NumTempi);
...
console.log("sec1Tempi: " + sec1Tempi);
...
console.log("timeGridA: " + timeGrid);
...
console.log("timeGridB: " + timeGrid);
...
console.log("timeCodeByPart: " + timeCodeByPart);
//MAKE PITCH DATA
...
fetch('/pitchdata/sfAalysis003.txt')
  ...
  .then(text => {
    ...
    console.log("pitchesArray1: " + pitchesArray1);
  })
  .then(valArr => {
...
console.log("sec2TimeCodeByPart: " + sec2TimeCodeByPart);
...
console.log("sec3AccelTimeCode: " + sec3AccelTimeCode);
...
console.log("sec4TimeCode: " + sec4TimeCode);
